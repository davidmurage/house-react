  ...
  return <section>
    ...
    mb-14'>
      ...
      <div className='mb-4 lg:mb-0 flex gap-x-2 text-sm'>
        ...
        <div className='bg-violet-500 text-white px-3
        rounded-full'>{house.country}</div>
      </div>
     ...
     <div className='max-w-[768px]'>
      ...
      border-gray-300 rounded-1g px-6 py-8'>
        ...
        <div>
          ...
          <form  className='flex flex-col gap-y-4'>
            ...
            <div className='flex gap-x-2'>
              ...
              rounded p-4 text-sm w-full transition'>Send message</button>
